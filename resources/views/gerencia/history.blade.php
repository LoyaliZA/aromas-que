    ...
    <div x-data="{
        ...
        <div class="bg-aromas-secondary p-4 rounded-xl shadow-lg border border-aromas-tertiary/20 mb-6">
            <div class="flex flex-col md:flex-row gap-4 items-end">
                ...
                <div class="w-full md:w-auto"><label class="text-xs text-aromas-tertiary mb-1 block">Estado</label><select x-model="status" @change="fetchResults()" class="bg-black/20 border border-aromas-tertiary/30 rounded-lg px-3 py-2 text-white w-full"><option value="ALL">Todos</option><option value="IN_STORE">En Tienda</option><option value="IN_CUSTODY">En Custodia</option><option value="DELIVERED">Entregados</option></select></div>
                <div class="w-full md:w-auto"><label class="text-xs text-aromas-tertiary mb-1 block">Depto</label><select x-model="department" @change="fetchResults()" class="bg-black/20 border border-aromas-tertiary/30 rounded-lg px-3 py-2 text-white w-full"><option value="ALL">Todos</option><option value="AROMAS">Aromas</option><option value="BELLAROMA">Bellaroma</option><option value="CALLCENTER">Call Center</option></select></div>
