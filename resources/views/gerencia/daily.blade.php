                        ...
                        <form id="createForm" action="{{ route('gerencia.store') }}" method="POST">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="grid grid-cols-12 gap-4">
                                    <div class="col-span-3"><label class="block text-sm font-medium text-aromas-tertiary mb-1">ID</label><input type="text" name="client_ref_id" required class="w-full bg-black/20 border border-aromas-tertiary/30 rounded-lg px-3 py-2 text-white focus:border-aromas-highlight transition-colors"></div>
